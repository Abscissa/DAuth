...
cd /D %2
rdmd -I..\InstaUser-Basic\src -I..\InstaUser-Store\src -I..\InstaUser-Web\src --build-only --force -c -Dddocs_tmp -X -Xfdocs\docs.json -version=InstaUser_Docs src\instauser\%1\package.d
