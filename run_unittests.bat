...
rdmd -unittest -version=InstaUser_Unittest -Isrc -main --force -ofbin\unittests-phobos -version=Have_mysql_native -m32 %* src\instauser\package.d

echo Building/Running full Vibe.d tests (Vibe.d sockets)
rdmd -unittest -version=InstaUser_Unittest -Isrc -main --force -ofbin\unittests-vibed -version=Have_mysql_native -version=Have_vibe_d ..\vibed-0.7.19\lib\win-i386\eay.lib ..\vibed-0.7.19\lib\win-i386\event2.lib -m32 %* src\instauser\package.d
